...
private:
  ...
  QuaternionDatagram* m_quaternion_datagram;
  JointAnglesDatagram* m_joint_angles_datagram;
  LinearSegmentKinematicsDatagram* m_linear_segment_kinematics_datagram;
  AngularSegmentKinematicsDatagram* m_angular_segment_kinematics_datagram;
  CenterOfMassDatagram* m_center_of_mass_datagram;
  TimeCodeDatagram* m_time_code_datagram;
};
