...
sudo -E bash sudoros2.sh run xsens_mvn_ros2 sub.py
pip uninstall general_motion_retargeting
sudo -E bash sudoros2.sh launch xsens_mvn_ros2 xsens_client.launch.py
